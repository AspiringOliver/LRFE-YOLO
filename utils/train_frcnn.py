...
if __name__ == "__main__":
    ...
    #---------------------------------------------------------------------#
    classes_path    = '/content/drive/MyDrive/demo/Faster-RCNN-Pytorch/faster-rcnn-pytorch-master/VOCdevkit/VOC2007/labels/classes.txt'
    #----------------------------------------------------------------------------------------------------------------------------#
    ...
    #   获得图片路径和标签
    #----------------------------------------------------#
    train_annotation_path   = '/content/drive/MyDrive/demo/Faster-RCNN-Pytorch/faster-rcnn-pytorch-master/VOCdevkit/VOC2007/2007_train.txt'
    val_annotation_path     = '/content/drive/MyDrive/demo/Faster-RCNN-Pytorch/faster-rcnn-pytorch-master/VOCdevkit/VOC2007/2007_val.txt'
