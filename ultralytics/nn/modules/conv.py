...
from ultralytics.nn.modules.LRFE_Transformer import *
# /content/drive/MyDrive/demo/ultralytics/ultralytics/nn/modules
__all__ = (
    "Conv",
    "Conv2",
    "LightConv",
...
class SMSBlock(nn.Module):
    def __init__(self,
                 ...
                 weight_factor=0.1, memory_blocks=128, down_rank=32,
                 drop_path=0.0,
                 split_size=1,
                 ):
